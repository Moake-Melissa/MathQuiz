...
namespace Math_Quiz
{
    public partial class Form1 : Form
    {
        ...
        public void StartTheQuiz()
        {
            ...
            currentDate.Text = currDate.ToString("dd MMMMM yyyy");
            ...
            // Convert the two raondomly generated numbers
            ...
            // This steo makes sure its value is zero before
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (CheckTheAnswer())
            {
                ...
                // got the answers right. Stop the timer
